...
typedef enum {
	COMMENTAIRE,ALTER,DELETE,DROP,ERREUR,IDENTIFICATEUR,POINT,APOSTROPHE,
	SEMICOLON,PAR_OUV,PAR_FER,ACCO_OUV,VIRGULE,FUNCTION,AGGREGATE,TYPE,
	TABLE,USER,KEYSPACE,ROLE,TRIGGER,INDEX,IF_TOKEN,EXISTS_TOKEN,MATERIALIZED,
	VIEW,INSERT,INTO,INTEGER_TOKEN,FLOAT_TOKEN,NAN,INFINITY,NULL_TOKEN,TRUE_TOKEN,
	FALSE_TOKEN,UUID_TOKEN,BLOB_TOKEN,STRING_TOKEN,DOUBLE_QUOTE,VALUES_TOKEN,JSON,
	NOT_TOKEN,USING,HEX_TOKEN,TIMESTAMP,TTL,AND,CRO_FER,CRO_OUV,ACCO_FER,POINT_INTERO,
	DEUX_POINT,EGAL,WITH,CREATE,USE,ON,ASCII_T,BIGINT_T,BLOB_T,BOOLEAN_T,COUNTER_T,
	DATE_T,DECIMAL_T,DOUBLE_T,FLOAT_T,INT_T,TEXT_T,INET_T,SMALLINT_T,TIME_T,TIMEUUID_T,
	TINYINT_T,UUID_T,VARCHAR_T,VARINT_T,MAP_TOKEN,LIST_TOKEN,SET_TOKEN,TUPLE_TOKEN,
	INF,SUP,COLUMNFAMILY,STATIC,PRIMARY,KEY,ORDER,CLUSTERING,COMPACT,STORAGE,CUSTOM,
	KEYS,OPTIONS,SELECT,ETOILE,COUNT_T,UN,AS_T,FROM_T,DISTINCT,LIMIT,ALLOW,WHERE,INFE,
	SUPE,CONTAINS,CONTAINSKEY,FILTERING,ASC,DESC,BY_T,WRITETIME_T,IN,TOKEN,UPDATE,DELETE_T,
	BEGIN_T,BATCH,APPLY_T,UNLOGGED,EXIT,PLUS,MINUS,DIV,AST_TOKEN}typetoken;
